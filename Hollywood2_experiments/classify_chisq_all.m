...
training.video_list = '/home/vaggelis/hollywood2_frames_c3d/classification/train_list.txt';
testing.video_list = '/home/vaggelis/hollywood2_frames_c3d/classification/test_list.txt';
features_dim = 4096;
layer = 'fc6';
svm_cost = 100;
...
load('./tsn/max/hollywood2_train_rgb_features.mat');
load('./tsn/max/hollywood2_train_flow_features.mat');

load('./tsn/max/hollywood2_val_rgb_features.mat');
load('./tsn/max/hollywood2_val_flow_features.mat');


%% load features from hmdb51 split2 cnns
load('./tsn/max/hollywood2_train_rgb_features_split2.mat');
load('./tsn/max/hollywood2_train_flow_features_split2.mat');

load('./tsn/max/hollywood2_val_rgb_features_split2.mat');
load('./tsn/max/hollywood2_val_flow_features_split2.mat');

%% load features from hmdb51 split3 cnns
load('./tsn/max/hollywood2_train_rgb_features_split3.mat');
load('./tsn/max/hollywood2_train_flow_features_split3.mat');

load('./tsn/max/hollywood2_val_rgb_features_split3.mat');
load('./tsn/max/hollywood2_val_flow_features_split3.mat');



train_rgb_features = [train_rgb_features, train_rgb_features_split2, train_rgb_features_split3];
train_flow_features = [train_flow_features, train_flow_features_split2, train_flow_features_split3];

test_rgb_features = [test_rgb_features, test_rgb_features_split2, test_rgb_features_split3];
test_flow_features = [test_flow_features, test_flow_features_split2, test_flow_features_split3];
...
%catch
    ...
    for i=1:length(training.videos)
        ...
        load(['/Data/hollywood2_DT/' training.videos{i} '.mat']);
        switch encoding_type
            case 'BoVW'
...
for i=1:length(testing.videos)
        ...
        load(['/Data/hollywood2_DT/' testing.videos{i} '.mat']);
        switch encoding_type
            case 'BoVW'
                encoded_features = encode_multichannel_bof(f, channels, 0);
            case 'fisher'
