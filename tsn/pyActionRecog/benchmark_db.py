...
def parse_cvsp_splits():
    class_ind = [x.strip().split() for x in open('/home/vaggelis/mov_frames_jpg/classification/tsn/classInd.txt')]
    class_mapping = {x[1]:int(x[0])-1 for x in class_ind}
    ...
    splits = []
    for i in xrange(1, 2):
        train_list = [line2rec(x) for x in open('/home/vaggelis/mov_frames_jpg/classification/tsn/trainlist{:02d}.txt'.format(i))]
        test_list = [line2rec(x) for x in open('/home/vaggelis/mov_frames_jpg/classification/tsn/testlist{:02d}.txt'.format(i))]
        splits.append((train_list, test_list))
    return splits


def parse_hollywood2_splits():
    class_ind = [x.strip().split() for x in open('/home/vaggelis/hollywood2_frames_c3d/classification/tsn/classInd.txt')]
    class_mapping = {x[1]:int(x[0])-1 for x in class_ind}
    ...
    splits = []
    for i in xrange(1, 2):
        train_list = [line2rec(x) for x in open('/home/vaggelis/hollywood2_frames_c3d/classification/tsn/trainlist{:02d}.txt'.format(i))]
        test_list = [line2rec(x) for x in open('/home/vaggelis/hollywood2_frames_c3d/classification/tsn/testlist{:02d}.txt'.format(i))]
        splits.append((train_list, test_list))
    return splits
